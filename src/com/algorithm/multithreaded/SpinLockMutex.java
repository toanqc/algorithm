...
/**
 * Design a mutex using 2 variable method assuming operation ice happens
 * atomically
 */
class Mutex {
	...
	/**
	 * Val is stored somewhere. If oldVal is same as val then you change val to
	 * newVal and return oldVal Otherwise you do nothing but return val
	 * 
	 * @param oldValue
	 * @param newValue
	 * @return
