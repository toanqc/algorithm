...
import com.algorithm.bits.NextPowerOf2;
...
public class SegmentTreeMinimumRangeQuery {
	...
	private void updateSegmentTree(int segmentTree[], int index, int delta, int low, int high, int pos) {
		...
		// if index to be updated is less than low or higher than high just
		// return.
		if (index < low || index > high) {
			return;
		}

		// if low and high become equal, then index will be also equal to them
		// and update
