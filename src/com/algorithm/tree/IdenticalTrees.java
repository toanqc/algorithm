...
public class IdenticalTrees {
	...
	/**
	 * Little simpler version of above implementation. Uses more space but
	 * atleast its easy to understand. All it does is makes 2 list one of larger
	 * and one of smaller element than root and then passes them into left and
	 * right sides
	 * 
	 * @param arr1
	 * @param arr2
	...
	/**
	 * It might not work for duplicate elements in array. For that you have to
	 * store both index and actual value to differentiate somehow.
	 */
