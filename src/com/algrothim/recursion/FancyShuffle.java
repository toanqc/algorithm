 ...
 * @author Tushar Roy
 * 
 *         Given an input with duplicate characters generate a shuffle which
 *         does not have two duplicate characters together
 * 
 *         Do regular permutation with repetition with additional constraint of
 *         keeping duplicates away from each other.
 *
 */
