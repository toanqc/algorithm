 ...
 *         http://articles.leetcode.com/2011/11/longest-palindromic-substring-
 *         part-ii.html http://www.akalin.cx/longest-palindrome-linear-time
...
public class LongestPalindromeSubstring {
	 ...
	 * There are 4 cases to handle Case 1 : Right side palindrome is totally
	 * contained under current palindrome. In this case do not consider this as
	 * center. Case 2 : Current palindrome is proper suffix of input. Terminate
	 * the loop in this case. No better palindrom will be found on right. Case 3
	 * : Right side palindrome is proper suffix and its corresponding left side
	 * palindrome is proper prefix of current palindrome. Make largest such
	 * point as next center. Case 4 : Right side palindrome is proper suffix but
	 * its left corresponding palindrome is be beyond current palindrome. Do not
	 * consider this as center because it will not extend at all.
	 *
	...
	public int longestPalindromicSubstringLinear(char input[]) {
		int index = 0;
		// preprocess the input to convert it into type abc -> $a$b$c$ to handle
		// even length case.
