...
public class BellmanFordShortestPath {
	...
	public Map<Vertex<Integer>, Integer> getShortestPath(Graph<Integer> graph, Vertex<Integer> startVertex) {
	...
	private int getDistance(Vertex<Integer> v, Map<Vertex<Integer>, Integer> distance) {
