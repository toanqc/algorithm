...
public class TrappingWater {
	...
	/**
	 * Keep two array left and right which has max till that point either from
	 * left side or right side. Now for every point i check if it is less than
	 * left[i] and right[i]. If yes then add this to total since water can be
	 * trapped here.
	 * 
	 * @param input
	 * @return
