...
/**
 * http://www.geeksforgeeks.org/increasing-subsequence-of-length-three-with-
 * maximum-product/ Keep two arrays which keeps max from current position to
 * right side Other array keeps max on left size which is smaller than current
 * element Once you have these two arrays from 2nd to 2nd last position keep
 * multiplying elements at 3 arrays index position to get max product Test cases
...
public class IncreasingSubsequnceOfLength3WithMaxProduct {
	...
	public int maxProduct(int arr[]) {
		...
		LGN[0] = 0;
		// This can be implemented using an AVL tree instead of this way which
		// will
