package com.algrothim.array;

/**
 * http://www.geeksforgeeks.org/find-a-tour-that-visits-all-stations/ You can
 * solve this one using kadane wrap since it finds max contiguous sum for
 * wrapped array. That start point is a best place to start a tour. Test cases
 * Check if length of both input array is same Check that there exists a path
 * after kadane wrap responds Check that there is at least one positive
 * difference before you call kadane
 */
public class GasStationCircle {
	...
	/**
	 * This solution assumes that a tour does exists. If it is not guaranteed
	 * that tour exists then once you get result of kadanewrap make an actual
