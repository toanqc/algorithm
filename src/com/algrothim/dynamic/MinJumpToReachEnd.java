 ...
 *         end of the array from first element
 * 
 *         Solution Have 2 for loop. j trails i. If arr[j] + j >= i then you
 *         calculate new jump and result.
 * 
 *         Space complexity O(n) to maintain result and min jumps Time
 *         complexity O(n^2)
 * 
 *         Reference
 *         http://www.geeksforgeeks.org/minimum-number-of-jumps-to-reach-end-of-
 *         a-given-array/
 */
