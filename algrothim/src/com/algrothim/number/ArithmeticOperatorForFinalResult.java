...
/**
 * Given a series of numbers as the input, the last one as the result. Use the
 * rest numbers to calculate the result,only +, -, *, / are allowed. The order
 * of the input cannot be changed. If there is an equation, print it; or print
 * "no equation". If more than one solution, any working equation is fine.
 * 
 * Test cases: 0 with / operator Input array is less than size 1 Does not handle
 * float/double, does division with integer results. Total is negative number,
