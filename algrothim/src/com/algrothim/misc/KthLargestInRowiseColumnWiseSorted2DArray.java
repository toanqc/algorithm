...
import com.algrothim.graph.BinaryMinHeap;

/**
 * Kth largest in rowwise and column wise sorted array
 * http://www.geeksforgeeks.org/kth-smallest-element-in-a-row-wise-and-column-
 * wise-sorted-2d-array-set-1/
 */
public class KthLargestInRowiseColumnWiseSorted2DArray {
	...
	public static void main(String args[]) {
		int input[][] = { { 1, 5, 11, 21 }, { 6, 8, 12, 22 }, { 7, 9, 15, 26 }, { 11, 13, 18, 28 } };
