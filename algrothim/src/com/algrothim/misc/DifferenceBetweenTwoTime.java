package com.algrothim.misc;

/**
 * Given two times in four digits number e.g 10:10 is 1010 find difference
 * between them Test cases Time 1 better be less than equal to time 2 First 2
 * digits better be between 0 and 23 Last 2 digits of number better be between 0
 * to 59
 */
