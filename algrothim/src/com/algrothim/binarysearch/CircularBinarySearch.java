package com.algrothim.binarysearch;

/**
 * http://www.careercup.com/question?id=4877486110277632 Given a circle with N
 * defined points and a point M outside the circle, find the point that is
 * closest to M among the set of N. O(LogN) Test cases 1) smallest element at
 * center 2) smallest element at left/right end 3) largest element at center 4)
 * smallest element at left side 5) smallest element at right side
 */
public class CircularBinarySearch {
	...
	public int search(int arr[]) {
		...
		while (low < high) {
			mid = (low + high) / 2;
			// if middle is less than both mid-1 and mid+1 then mid is the
			// answer
