 ...
 *
 *         Given a binary tree print its level order traversal in reverse e.g 1
 *         2 3 4 5 6 7
 * 
 *         Output should be 4 5 6 7 2 3 1
 * 
 *         Solution Maintain a stack and queue. Do regular level order traversal
 *         but put right first in the queue. Instead of printing put the result
