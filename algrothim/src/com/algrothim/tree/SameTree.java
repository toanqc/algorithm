 ...
 * 
 *         Given roots of two tree, return true if they have same data and same
 *         structure or return false.
 * 
 *         Solution Keep comparing root of both data and then recursively check
 *         left and right.
 * 
