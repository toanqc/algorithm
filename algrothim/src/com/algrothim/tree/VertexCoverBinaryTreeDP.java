 ...
 * solution-tree/ http://en.wikipedia.org/wiki/Vertex_cover Using lis to store
 * the cover data Test cases: null root Only left child Only right child Tree
 * with only one child at every node
 */
