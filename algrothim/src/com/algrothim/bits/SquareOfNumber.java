package com.algrothim.bits;

/**
 * http://www.careercup.com/question?id=5748016728244224 Square of number
 * without using * or ^ operation. Test cases How to deal with negative number 0
 * Power of 2 number Regular numbers
 */
public class SquareOfNumber {
	...
	public int square(int n) {
		...
		int result = 0;
		int k = n;
		// so we doing 7*7. First lets get rid of 3 from that 7 by below
		// operation.
