 ...
 *
 *         References
 *         http://www.geeksforgeeks.org/dynamic-programming-set-21-box-stacking-
 *         problem/ http://people.cs.clemson.edu/~bcdean/dp_practice/
 */
public class BoxStacking {

	public int maxHeight(Dimension[] input) {
		// get all rotations of box dimension.
		// e.g if dimension is 1,2,3 rotations will be 2,1,3 3,2,1 3,1,2 . Here
		// length is always greater
		...
		// apply longest increasing subsequence kind of algorithm on these
		// sorted boxes.
