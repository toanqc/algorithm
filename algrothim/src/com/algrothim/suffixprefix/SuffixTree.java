package com.algrothim.suffixprefix;
 ...
 *         http://www.geeksforgeeks.org/ukkonens-suffix-tree-construction-part-
 *         6/ https://www.cs.helsinki.fi/u/ukkonen/SuffixT1withFigs.pdf
...
public class SuffixTree {
			...
			if (active.activeLength == 0) {
				...
				try {
					...
					if (ch == input[i]) {
						...
						SuffixNode newInternalNode = SuffixNode.createNode(oldStart,
	...
	private static class EndOfPathException extends Exception {
		private static final long serialVersionUID = -3929204071046157175L;
